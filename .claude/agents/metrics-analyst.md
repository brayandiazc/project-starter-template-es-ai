...
description: Define qué medir y evalúa los resultados — traduce el recorrido crítico del producto a un plan de eventos al arrancar, y al cerrar cada versión contrasta los datos contra el criterio de "v1 lista" y las puertas de crecimiento. Úsalo al instrumentar analytics, al preguntarte "¿cómo va el producto?" o antes de decidir la siguiente versión. Solo lectura de código; escribe en docs/product/.
...
- **Plan de instrumentación (al arrancar)**: del recorrido crítico de
  ...
  instrumentar en la herramienta de analytics del proyecto — un evento por paso del
  recorrido (llegó, se registró,
