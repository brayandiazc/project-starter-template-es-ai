...
| `docs/product/business-model.md`        | `docs/product/product-definition.md` | El negocio es ahora una sección de la definición de producto: mover precio, canal, costos y métrica                                                                                                  |
...
| `docs/glossary.md`                      | —                                    | Eliminado (huérfano: nada lo referenciaba). Si el tuyo tiene contenido, muévelo a una sección de vocabulario en `docs/product/product-definition.md`                                                 |
...
| `.github/scripts/check-costos.sh`       | `.github/scripts/check-costs.sh`     | Renombrado, junto con `check-herencia`→`check-inheritance`, `check-hooks-activos`→`check-hooks-enabled` y `check-instrucciones`→`check-instructions`. El código va en inglés, también sus archivos   |
